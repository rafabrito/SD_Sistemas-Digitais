// proj_qsys_jogo_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module proj_qsys_jogo_mm_interconnect_0 (
	...
	wire  [87:0] cmd_mux_src_data;                                                           // cmd_mux:src_data -> Jtag_avalon_jtag_slave_agent:cp_data
	wire         cmd_mux_src_ready;                                                          // Jtag_avalon_jtag_slave_agent:cp_ready -> cmd_mux:src_ready
	wire   [3:0] cmd_mux_src_channel;                                                        // cmd_mux:src_channel -> Jtag_avalon_jtag_slave_agent:cp_channel
	...
	wire  [87:0] cmd_mux_001_src_data;                                                       // cmd_mux_001:src_data -> Nios_debug_mem_slave_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                      // Nios_debug_mem_slave_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [3:0] cmd_mux_001_src_channel;                                                    // cmd_mux_001:src_channel -> Nios_debug_mem_slave_agent:cp_channel
	...
	wire  [88:0] memory_s1_agent_rf_source_data;                                             // memory_s1_agent:rf_source_data -> memory_s1_agent_rsp_fifo:in_data
	...
	wire  [88:0] memory_s1_agent_rsp_fifo_out_data;                                          // memory_s1_agent_rsp_fifo:out_data -> memory_s1_agent:rf_sink_data
	...
	wire  [87:0] cmd_mux_002_src_data;                                                       // cmd_mux_002:src_data -> memory_s1_agent:cp_data
	wire         cmd_mux_002_src_ready;                                                      // memory_s1_agent:cp_ready -> cmd_mux_002:src_ready
	wire   [3:0] cmd_mux_002_src_channel;                                                    // cmd_mux_002:src_channel -> memory_s1_agent:cp_channel
	...
	wire  [88:0] buttons_s1_agent_rf_source_data;                                            // buttons_s1_agent:rf_source_data -> buttons_s1_agent_rsp_fifo:in_data
	...
	wire  [88:0] buttons_s1_agent_rsp_fifo_out_data;                                         // buttons_s1_agent_rsp_fifo:out_data -> buttons_s1_agent:rf_sink_data
	...
	wire  [87:0] cmd_mux_003_src_data;                                                       // cmd_mux_003:src_data -> buttons_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                      // buttons_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [3:0] cmd_mux_003_src_channel;                                                    // cmd_mux_003:src_channel -> buttons_s1_agent:cp_channel
	...
	wire  [87:0] jtag_avalon_jtag_slave_agent_rp_data;                                       // Jtag_avalon_jtag_slave_agent:rp_data -> router_002:sink_data
	...
	wire  [87:0] nios_debug_mem_slave_agent_rp_data;                                         // Nios_debug_mem_slave_agent:rp_data -> router_003:sink_data
	...
	wire  [87:0] memory_s1_agent_rp_data;                                                    // memory_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [87:0] buttons_s1_agent_rp_data;                                                   // buttons_s1_agent:rp_data -> router_005:sink_data
	...
	proj_qsys_jogo_mm_interconnect_0_router router (
	...
	proj_qsys_jogo_mm_interconnect_0_router router_001 (
	...
	proj_qsys_jogo_mm_interconnect_0_router_002 router_002 (
	...
	proj_qsys_jogo_mm_interconnect_0_router_002 router_003 (
	...
	proj_qsys_jogo_mm_interconnect_0_router_002 router_004 (
	...
	proj_qsys_jogo_mm_interconnect_0_router_002 router_005 (
	...
	proj_qsys_jogo_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (Clk_clk_clk),                            //       clk.clk
		.reset              (Nios_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	proj_qsys_jogo_mm_interconnect_0_cmd_demux cmd_demux_001 (
		.clk                (Clk_clk_clk),                            //       clk.clk
		.reset              (Nios_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	proj_qsys_jogo_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (Clk_clk_clk),                            //       clk.clk
		.reset               (Nios_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	proj_qsys_jogo_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (Clk_clk_clk),                            //       clk.clk
		.reset               (Nios_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	proj_qsys_jogo_mm_interconnect_0_cmd_mux cmd_mux_002 (
		.clk                 (Clk_clk_clk),                            //       clk.clk
		.reset               (Nios_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	proj_qsys_jogo_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (Clk_clk_clk),                            //       clk.clk
		.reset               (Nios_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	proj_qsys_jogo_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (Clk_clk_clk),                            //       clk.clk
		.reset              (Nios_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	proj_qsys_jogo_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (Clk_clk_clk),                            //       clk.clk
		.reset              (Nios_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	proj_qsys_jogo_mm_interconnect_0_rsp_demux rsp_demux_002 (
		.clk                (Clk_clk_clk),                            //       clk.clk
		.reset              (Nios_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	proj_qsys_jogo_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (Clk_clk_clk),                            //       clk.clk
		.reset              (Nios_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	proj_qsys_jogo_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (Clk_clk_clk),                            //       clk.clk
		.reset               (Nios_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	proj_qsys_jogo_mm_interconnect_0_rsp_mux rsp_mux_001 (
		.clk                 (Clk_clk_clk),                            //       clk.clk
		.reset               (Nios_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	proj_qsys_jogo_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
